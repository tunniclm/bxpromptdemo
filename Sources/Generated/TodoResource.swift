...
public class TodoResource {
    private let adapter: TodoAdapter
    private let path = "/api/todos"
    private let pathWithID = "/api/todos/:id"

    init(factory: AdapterFactory) throws {
        adapter = try factory.getTodoAdapter()
    }
